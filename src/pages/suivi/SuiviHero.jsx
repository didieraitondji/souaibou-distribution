...
export default function SuiviHero({ onSearch, loading, error }) {
    ...
    return (
        ...
        >
            ...
            <div className="max-w-275 mx-auto relative z-10 text-center">
                {/* Breadcrumb */}
                ...
                <p className="text-[15px] text-neutral-6 leading-relaxed mb-10 max-w-120 mx-auto">
                    Entrez votre numéro de commande pour suivre la livraison en temps réel.
                </p>

                {/* Barre de recherche */}
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-130 mx-auto">
                    ...
                    >
                        {loading ? <span className="text-h6" style={{ animation: "spin 1s linear infinite", display: "inline-block" }}>⏳</span> : "Rechercher"}
                    </button>
                </form>
