                    ...
                    <div className="max-w-275 mx-auto">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
                            <div>
                                ...
                                <h2 className="font-extrabold text-h5 text-neutral-9">{order.id}</h2>
                            </div>
                            <button
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            {[
                                ...
                                <div key={item.title} className="bg-neutral-0 rounded-2xl border border-neutral-4 p-6 text-center">
                                    <div className="text-h3 mb-3">{item.icon}</div>
                                    <h3 className="font-bold text-sm text-neutral-9 mb-2">{item.title}</h3>
